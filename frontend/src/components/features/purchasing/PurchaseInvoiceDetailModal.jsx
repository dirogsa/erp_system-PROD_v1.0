...
const PurchaseInvoiceDetailModal = ({
    ...
    const handleExportPdf = async () => {
        ...
        try {
            await exportElementToPdf(receiptRef.current, `factura_compra_${invoice.invoice_number || 'invoice'}.pdf`);
        } catch (err) {
                ...
                <div style={{
                    ...
                    <div>
                        <h2 style={{ color: 'white', margin: 0, fontSize: '1.5rem' }}>
                            Factura de Proveedor {invoice.invoice_number}
                        </h2>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'center' }}>
                            <div style={{ background: 'white', padding: '8mm' }}>
                                <div>
                                    ...
                                    customer_name: invoice.supplier_name || invoice.supplier || '',
                                    delivery_address: invoice.delivery_address,
                                    items: invoice.items,
                                    notes: invoice.notes,
                                    total: invoice.total_amount
                                }} docType="Factura" docKind="purchase" docRole="invoice" extraNotes={printNotes} />
                                </div>
                            </div>
                        </div>
                    ) : (
                        /* Rest of invoice details: reuse similar layout as sales invoice detail */
                        <div>
                            <div style={{
                                display: 'grid',
                            ...
                            <div style={{ marginBottom: '2rem' }}>
                                <h3 style={{ color: '#e2e8f0', marginBottom: '1rem', fontSize: '1.1rem' }}>Proveedor</h3>
                                <div style={{
                                    backgroundColor: '#1e293b',
                                    padding: '1.5rem',
                                    borderRadius: '0.5rem',
                                    ...
                                    <div>
                                        ...
                                        <p style={{ color: 'white' }}>{invoice.supplier_name || invoice.supplier}</p>
                                    </div>
